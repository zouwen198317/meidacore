...
int ff_avc_parse_nal_units_t(ByteIOContext *pb, const uint8_t *buf_in, int size)
{
    const uint8_t *p = buf_in;
    const uint8_t *end = p + size;
    const uint8_t *nal_start, *nal_end;
...
int ff_avc_parse_nal_units_buf(const uint8_t *buf_in, uint8_t **buf, int *size)
{
    ...
    ff_avc_parse_nal_units_t(pb, buf_in, *size);
    //ff_avc_parse_nal_units(buf_in, buf, size);
